...
const buildDOM = (...directions: string[]) => {
...
const fromVarsOf = (callIndex: number): Record<string, unknown> =>
  mockFromTo.mock.calls[callIndex]?.[1] as Record<string, unknown>;
...
describe("ScrollReveal", () => {
  ...
  it("animates to opacity:1, x:0, y:0", () => {
    ...
    const toVars = mockFromTo.mock.calls[0]?.[2] as Record<string, unknown>;
